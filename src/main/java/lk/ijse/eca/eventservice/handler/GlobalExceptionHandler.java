package lk.ijse.eca.eventservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleEventNotFound(
        ...
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.NOT_FOUND, "Event Not Found", ex.getMessage(), request.getRequestURI());
        return problemResponse(HttpStatus.NOT_FOUND, problem);
    }

    @ExceptionHandler(DuplicateEventException.class)
    public ResponseEntity<ProblemDetail> handleDuplicateEvent(
            DuplicateEventException ex, HttpServletRequest request) {
        log.warn("Duplicate event: {}", ex.getMessage());
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.CONFLICT, "Duplicate Event", ex.getMessage(), request.getRequestURI());
